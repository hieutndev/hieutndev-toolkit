...
async function refreshToken() {
  ...
  headers.append("Authorization", `Bearer ${(0, import_cookies_next.getCookie)("refresh_token") || ""}`);
  ...
  (0, import_cookies_next.setCookie)("refresh_token", data.results.refresh_token, { path: "/" });
}
